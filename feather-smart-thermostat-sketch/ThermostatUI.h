...
const unsigned char cloudicon [] PROGMEM = {
  ...
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xc0, 0x00, 0x00, 0x07, 0x70, 0x00, 
  0x00, 0x3c, 0x18, 0x00, 0x00, 0x60, 0x0c, 0x00, 0x00, 0xc0, 0x04, 0x00, 0x00, 0x80, 0x04, 0x00, 
  0x00, 0x80, 0x04, 0x00, 0x07, 0x80, 0x05, 0xc0, 0x0c, 0x00, 0x07, 0x70, 0x18, 0x00, 0x00, 0x18, 
  0x30, 0x00, 0x00, 0x0c, 0x20, 0x00, 0x00, 0x04, 0x20, 0x00, 0x00, 0x04, 0x20, 0x00, 0x00, 0x04, 
  0x30, 0x00, 0x00, 0x0c, 0x18, 0x00, 0x00, 0x18, 0x0c, 0x00, 0x00, 0x30, 0x07, 0xff, 0xff, 0xe0, 
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
const unsigned char wifiicon [] PROGMEM = {
  ...
  0x01, 0xfc, 0x1f, 0xc0, 0x03, 0xc0, 0x01, 0xe0, 0x03, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00, 
  0x00, 0x07, 0xf0, 0x00, 0x00, 0x1f, 0xfc, 0x00, 0x00, 0x7c, 0x1f, 0x00, 0x00, 0x70, 0x07, 0x00, 
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xe0, 0x00, 0x00, 0x0f, 0xf8, 0x00, 
  0x00, 0x0e, 0x38, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xc0, 0x00, 
  0x00, 0x01, 0xc0, 0x00, 0x00, 0x01, 0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

// 'disabled-icon', 32x32px
const unsigned char disabledicon [] PROGMEM = {
  0x00, 0x0f, 0xf0, 0x00, 0x00, 0x7f, 0xfe, 0x00, 0x01, 0xf0, 0x0f, 0x80, 0x03, 0xc0, 0x03, 0xc0, 
  0x07, 0x00, 0x00, 0xe0, 0x0e, 0x00, 0x00, 0x70, 0x1c, 0x00, 0x00, 0x78, 0x38, 0x00, 0x00, 0xfc, 
  0x30, 0x00, 0x01, 0xcc, 0x70, 0x00, 0x03, 0x8e, 0x60, 0x00, 0x07, 0x06, 0x60, 0x00, 0x0e, 0x06, 
  0xc0, 0x00, 0x1c, 0x03, 0xc0, 0x00, 0x38, 0x03, 0xc0, 0x00, 0x70, 0x03, 0xc0, 0x00, 0xe0, 0x03, 
  0xc0, 0x01, 0xc0, 0x03, 0xc0, 0x03, 0x80, 0x03, 0xc0, 0x07, 0x00, 0x03, 0xc0, 0x0e, 0x00, 0x03, 
  0x60, 0x1c, 0x00, 0x06, 0x60, 0x38, 0x00, 0x06, 0x70, 0x70, 0x00, 0x0e, 0x30, 0xe0, 0x00, 0x0c, 
  0x39, 0xc0, 0x00, 0x1c, 0x1f, 0x80, 0x00, 0x38, 0x0f, 0x00, 0x00, 0x70, 0x07, 0x00, 0x00, 0xe0, 
...
namespace Thermostat {
  ...
  struct Display {
    ...
    void print_humidity(float humidity, int rect_height, int margin) {
      ...
      epd.setCursor((epd.width() - 64 - margin*2)/2 - w/2 + 64 + margin*2, (epd.height() - margin*2 - rect_height/2) + h/2);
      epd.print(str.c_str());
    }
    ...
    void update(const State& state) {
      ...
      epd.drawBitmap(margin*3, epd.height() - 32, wifiicon, 32, 32, EPD_BLACK);
      if (!state.wifi_online) {
        epd.drawBitmap(margin*3, epd.height() - 32, disabledicon, 32, 32, EPD_BLACK);
      }
      
      epd.drawBitmap(margin*3 + margin + 32, epd.height() - 32, cloudicon, 32, 32, EPD_BLACK);
      if (!state.mqtt_online) {
        epd.drawBitmap(margin*3 + margin + 32, epd.height() - 32, disabledicon, 32, 32, EPD_BLACK);
      }
