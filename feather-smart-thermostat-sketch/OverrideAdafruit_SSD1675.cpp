...
*/
/**************************************************************************/
OverrideAdafruit_SSD1675::OverrideAdafruit_SSD1675(int width, int height, int8_t SID,
...
*/
/**************************************************************************/
OverrideAdafruit_SSD1675::OverrideAdafruit_SSD1675(int width, int height, int8_t DC, int8_t RST,
...
*/
/**************************************************************************/
void OverrideAdafruit_SSD1675::busy_wait(void) {
  if (_busy_pin >= 0) {
...
*/
/**************************************************************************/
void OverrideAdafruit_SSD1675::begin(bool reset) {
...
*/
/**************************************************************************/
void OverrideAdafruit_SSD1675::update() {
  uint8_t buf[1];

  // display update sequence
  //buf[0] = 0x00;
  //EPD_command(SSD1675_DISP_CTRL1, buf, 1);
...
*/
/**************************************************************************/
void OverrideAdafruit_SSD1675::powerUp() {
  uint8_t buf[5];
...
*/
/**************************************************************************/
void OverrideAdafruit_SSD1675::powerDown() {
  uint8_t buf[1];
...
*/
/**************************************************************************/
uint8_t OverrideAdafruit_SSD1675::writeRAMCommand(uint8_t index) {
  if (index == 0) {
...
*/
/**************************************************************************/
void OverrideAdafruit_SSD1675::setRAMAddress(uint16_t x, uint16_t y) {
  uint8_t buf[2];
