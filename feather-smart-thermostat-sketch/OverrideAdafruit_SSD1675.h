#ifndef LIB_OVERRIDEADAFRUIT_SSD1675
#define LIB_OVERRIDEADAFRUIT_SSD1675
...
*/
/**************************************************************************/
class OverrideAdafruit_SSD1675 : public Adafruit_EPD {
public:
  OverrideAdafruit_SSD1675(int width, int height, int8_t SID, int8_t SCLK, int8_t DC,
                   int8_t RST, int8_t CS, int8_t SRCS, int8_t MISO,
                   int8_t BUSY = -1);
  OverrideAdafruit_SSD1675(int width, int height, int8_t DC, int8_t RST, int8_t CS,
