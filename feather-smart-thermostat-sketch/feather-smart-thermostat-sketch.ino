...
#define WIFI_SSID "benfica"
#define WIFI_PASSWORD "escola tecnica"
...
OverrideAdafruit_SSD1675 epd(250, 122, EPD_DC, EPD_RESET, EPD_CS, SRAM_CS, EPD_BUSY);
...
void loop() {
  ...
  Serial.println("Rendering to buffer");
  ...
  Serial.println("Finished rendering, sending to screen...");
  epd.display();
